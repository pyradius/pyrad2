...
class VersionFromAlpnTests(unittest.TestCase):
    def test_none_defaults_to_v1_0(self):
        self.assertIs(version_from_alpn(None), RadiusVersion.V1_0)

    def test_radius_1_0(self):
        self.assertIs(version_from_alpn(ALPN_V1_0), RadiusVersion.V1_0)

    def test_radius_1_1(self):
        self.assertIs(version_from_alpn(ALPN_V1_1), RadiusVersion.V1_1)

    def test_unknown_alpn_falls_back_to_v1_0(self):
        self.assertIs(version_from_alpn("h2"), RadiusVersion.V1_0)
...
class NegotiateTests(unittest.TestCase):
    ...
    def test_peer_no_alpn_with_v1_0_in_config_falls_back(self):
        self.assertIs(
            negotiate((RadiusVersion.V1_0,), None), RadiusVersion.V1_0
        )
        self.assertIs(
            negotiate(
    ...
    def test_peer_no_alpn_strict_v1_1_raises(self):
        ...
        with self.assertRaises(NoCommonRadiusVersion):
...
class EnforceTlsVersionFloorTests(unittest.TestCase):
...
class ApplyAlpnTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_v1_1_added_calls_set_alpn_with_v1_1_first(self):
        ...
        self.assertEqual(recorded, [[ALPN_V1_1, ALPN_V1_0]])
...
class TokenCounterTests(unittest.TestCase):
    def test_next_advances_by_one(self):
        ...
        self.assertEqual(second, (first + 1) & 0xFFFFFFFF)

    def test_wraps_around_32_bits(self):
        tc = TokenCounter()
        tc._value = 0xFFFFFFFE
        self.assertEqual(int.from_bytes(tc.next(), "big"), 0xFFFFFFFE)
        self.assertEqual(int.from_bytes(tc.next(), "big"), 0xFFFFFFFF)
        self.assertEqual(int.from_bytes(tc.next(), "big"), 0)


class PacketGatingTests(unittest.TestCase):
    ...
    def test_pw_crypt_is_identity_in_v1_1(self):
        ...
        self.assertEqual(pkt.pw_crypt("hunter2"), b"hunter2")

    def test_pw_decrypt_is_identity_in_v1_1(self):
        pkt = self._v11_auth_packet()
        self.assertEqual(pkt.pw_decrypt(b"hunter2"), "hunter2")
    ...
    def test_verify_auth_request_returns_true_in_v1_1(self):
        ...
        self.assertTrue(parsed.verify_auth_request())
    ...
    def test_request_packet_emits_token_and_zero_id(self):
        ...
        self.assertEqual(code, PacketType.AccessRequest)
        ...
        self.assertEqual(raw[8:20], b"\x00" * 12)
        # First 4 bytes after the header are the Token.
        self.assertEqual(raw[4:8], pkt.token)
    ...
    def test_reply_packet_echoes_request_token_and_skips_md5(self):
        ...
        self.assertEqual(raw[4:8], request.token)
    ...
    def test_verify_reply_matches_on_token_in_v1_1(self):
        ...
        self.assertTrue(request.verify_reply(parsed_reply, raw_reply))
    ...
    def test_verify_reply_rejects_wrong_token_in_v1_1(self):
        ...
        self.assertFalse(request.verify_reply(parsed_reply, bytes(raw_reply)))
    ...
    def test_decode_silently_discards_message_authenticator_in_v1_1(self):
        ...
        self.assertNotIn(80, parsed)
        self.assertFalse(parsed.has_message_authenticator())
    ...
    def test_set_obfuscated_user_password_v1_1_emits_plaintext(self):
        ...
        self.assertEqual(parsed["User-Password"], ["hunter2"])
    ...
    def test_set_obfuscated_user_password_v1_0_applies_pw_crypt(self):
        ...
        self.assertEqual(parsed.pw_decrypt(obfuscated), "hunter2")
    ...
    def test_set_obfuscated_encrypt_2_v1_1_emits_plaintext(self):
        ...
        self.assertEqual(parsed["Test-Encrypted-String"], ["secret-value"])
    ...
    def test_serialization_does_not_mutate_packet_dict(self):
        ...
        self.assertEqual(list(pkt.keys()), before_keys)
        self.assertEqual(
    ...
    def test_set_obfuscated_re_encodes_when_version_flips(self):
        ...
        self.assertNotIn(b"hunter2", raw_v10)
        # decrypt to confirm round-trip works
        parsed_v10 = parse_packet(raw_v10, b"radsec", radsec_dict)
        self.assertEqual(parsed_v10.pw_decrypt(parsed_v10[2][0]), "hunter2")
        ...
        self.assertNotIn(b"hunter2", raw_v10_again)
    ...
    def test_v1_0_packet_is_unchanged_after_radius_version_added(self):
        ...
        self.assertEqual(raw[4:20], b"0123456789ABCDEF")

    def test_create_reply_propagates_radius_version(self):
        request = self._v11_auth_packet()
        reply = request.create_reply()
        self.assertEqual(reply.radius_version, RadiusVersion.V1_1)
    ...
    def test_parse_packet_v1_1_round_trip(self):
        ...
        self.assertEqual(parsed["Test-Encrypted-String"], ["rfc9765"])
...
class DeferredObfuscatedVendorTests(unittest.TestCase):
    ...
    def test_set_obfuscated_vendor_attribute_v1_1_emits_vsa(self):
        ...
        self.assertEqual(raw[20], 26, "deferred vendor attr must wrap in VSA-26")
        vendor_id = struct.unpack("!L", raw[22:26])[0]
        self.assertEqual(vendor_id, 311)
        ...
        self.assertEqual(parsed["MS-MPPE-Recv-Key"], [b"secret"])
...
class DeferredObfuscatedContainerTests(unittest.TestCase):
    ...
    def test_deferred_tlv_subattribute_wraps_in_tlv_parent(self):
        ...
        self.assertEqual(raw[20], 60, "deferred TLV sub must nest under parent")
        ...
        self.assertIn("TestTlv-Secret", container)
        self.assertEqual(container["TestTlv-Secret"], ["value"])
    ...
    def test_deferred_tlv_subattribute_v1_1_emits_plaintext_in_tlv(self):
        ...
        self.assertEqual(parsed["TestTlv"]["TestTlv-Secret"], ["value"])
    ...
    def test_deferred_tlv_subattribute_preserves_non_deferred_siblings(self):
        ...
        self.assertIn("TestTlv-Secret", container)
        self.assertIn("TestTlv-Label", container)
        self.assertEqual(container["TestTlv-Secret"], ["value"])
        self.assertEqual(container["TestTlv-Label"], ["visible"])
    ...
    def test_deferred_evs_attribute_emits_extended_vsa(self):
        ...
        self.assertEqual(raw[20], 241)
        # Plaintext must NOT be on the wire (v1.0 salt obfuscation applied).
        self.assertNotIn(b"hush", raw)

        parsed = parse_packet(raw, b"radsec", dictionary)
        # Round-trips through the same EVS path.
        self.assertEqual(parsed["Example-Secret"], [b"hush"])


class StampRadiusVersionTests(unittest.TestCase):
    ...
    def test_v1_0_negotiation_clears_prior_v1_1_state(self):
        ...
        self.assertIs(pkt.radius_version, RadiusVersion.V1_0)
    ...
    def test_v1_1_negotiation_stamps_token(self):
        ...
        self.client._stamp_radius_version(pkt)
        self.assertIs(pkt.radius_version, RadiusVersion.V1_1)
        self.assertIsNotNone(pkt.token)
        self.assertEqual(len(pkt.token), 4)
    ...
    def test_v1_1_negotiation_preserves_existing_token(self):
        ...
        self.client._token_counter = TokenCounter()
        self.client._stamp_radius_version(pkt)
        self.assertEqual(pkt.token, original_token)


class V11StatusServerVerifierTests(unittest.TestCase):
    ...
    def test_v1_1_status_request_verifies_without_message_authenticator(self):
        ...
        self.assertTrue(parsed.verify_status_request())
    ...
    def test_v1_0_status_request_still_requires_message_authenticator(self):
        ...
        self.assertFalse(parsed.verify_status_request())
    ...
    def test_radsec_server_v1_1_status_passes_verify_packet(self):
        ...
        self.assertTrue(server._verify_packet(parsed))


class V11ChapTests(unittest.TestCase):
...
class RadSecAlpnConfigurationTests(unittest.TestCase):
    ...
    def test_server_default_v1_0_only(self):
        ...
        self.assertEqual(server.radius_versions, (RadiusVersion.V1_0,))
    ...
    def test_server_both_versions_advertises_alpn(self):
        ...
        self.assertEqual(
            server.radius_versions, (RadiusVersion.V1_0, RadiusVersion.V1_1)
        )
    ...
    def test_client_default_v1_0_only(self):
        ...
        self.assertEqual(client.radius_versions, (RadiusVersion.V1_0,))
        self.assertIs(client._negotiated_version, RadiusVersion.V1_0)
        self.assertIsNone(client._token_counter)
...
class RadSecV11EndToEndTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_both_sides_advertise_both_versions_negotiates_v1_1(self):
        ...
        try:
            ...
            try:
                ...
                self.assertEqual(client._negotiated_version, RadiusVersion.V1_1)
                self.assertIsNotNone(client._token_counter)
                self.assertIsNotNone(_IntegrationServer.captured)
                self.assertEqual(
                    _IntegrationServer.captured.radius_version, RadiusVersion.V1_1
                )
                # Password arrived in cleartext over TLS — no MD5 obfuscation.
                self.assertEqual(
                    _IntegrationServer.captured["User-Password"], ["hunter2"]
                )
            finally:
                await client.close()
        finally:
    ...
    async def test_asymmetric_v1_0_server_v1_1_client_negotiates_v1_0(self):
        ...
        try:
            ...
            try:
                ...
                self.assertEqual(client._negotiated_version, RadiusVersion.V1_0)
                self.assertIsNone(client._token_counter)
                self.assertEqual(
                    _IntegrationServer.captured.radius_version, RadiusVersion.V1_0
                )
            finally:
                await client.close()
        finally:
    ...
    async def test_strict_v1_1_server_closes_when_client_offers_no_alpn(self):
        ...
        try:
            ...
            try:
                ...
                self.assertIsNone(_IntegrationServer.captured)
            finally:
                await client.close()
        finally:
            await self._stop_server(listener)
    ...
    async def test_strict_v1_1_client_raises_when_server_offers_no_alpn(self):
        ...
        try:
            ...
            try:
                ...
                self.assertIn(
                    "No common RADIUS protocol", str(client.last_error)
                )
            finally:
                await client.close()
        finally:
